...
function refreshData() {
    ...
    function refreshTable(users) {
        ...
        $.each(users, function (key, object) {
            ...
            tBody += ('<td>' + object.department + '</td>');
            tBody += ('<td>' + object.salary + '</td>');
...
function editModal(id) {
    ...
    function fillFields(user) {
        ...
        $('#edDepartment').val(user.department);
        $('#edSalary').val(user.salary);
        $('#editModal').modal()
            ...
            body: JSON.stringify(
                {
                    ...
                    department: document.getElementById('edDepartment').value,
                    salary: document.getElementById("edSalary").value,
...
function deleteModal(id) {
    ...
    function fillFields(user) {
        ...
        $('#delDepartment').val(user.department);
        $('#delSalary').val(user.salary);
